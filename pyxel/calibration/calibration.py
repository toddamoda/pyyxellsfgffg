...
class Calibration:
    ...
    def __init__(self, settings, config):
        ...
        #     data_files = ['ccd270b-par-EPER-Ei1-one-image-single-4.txt', 'ccd270b-par-EPER-Ei1-one-image-single-8.txt',
        ...
        #                             7404.50146484,  # 12
        #                             12562.7226562]  # 16
        #     flatfield_illumination, target_output = read_former_campaign_data(data_path=opts.data,
    ...
    def log(self):
        ...
        with open('result.out', 'w') as file:
            ...
            file.write(
                '\n  Scales:           tr_p - ' + tr_scale + ';  nt_p - ' + nt_scale + ';  sigma_p - ' + sigma_scale + ';  beta - ' + beta_scale)
    ...
    #         algo = None
    #         if sga:
    #             opt_algorithm = pg.sga(gen=generations, cr=cr_prob,  # crossover probability
    ...
    #
    #         elif sade:
    #             opt_algorithm = pg.sade(gen=generations, variant=mutant_var, variant_adptv=self_adaptation_scheme,
    #                                     ftol=1e-6, xtol=1e-6, memory=False)
    #
