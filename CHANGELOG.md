...
**Add more instructions for setting a development environment with `uv`**
...
* New model [`Exponantial QE`](https://esa.gitlab.io/pyxel/doc/stable/references/model_groups/charge_generation_models.html#exponential-absorption-law) 
