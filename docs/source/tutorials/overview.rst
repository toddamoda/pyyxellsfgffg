...
.. tab:: Linux, MacOS, Windows (WSL)
    ...
    .. code-block:: bash
        ...
        curl -O https://esa.gitlab.io/pyxel/doc/latest/pyxel-1.7-environment.yaml
        conda env create -f pyxel-1.7-environment.yaml

.. tab:: Windows (Powershell)

    .. code-block:: bash

        wget https://esa.gitlab.io/pyxel/doc/latest/pyxel-1.7-environment.yaml -outfile "pyxel-1.7-environment.yaml"
        conda env create -f pyxel-1.7-environment.yaml
